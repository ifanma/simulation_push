function state = c2_task1(x0_, param)

    fileStateID = fopen('c2_state.dat','w');
    state = [0; double(x0_)];
...
%             fprintf(logFileID, 'currentTime = %f, dt = %f\r\n', currentTime, currentTime - lastTime);
            ...
            joy = mmap.Data;
%             fprintf(file, 'joy %d, %f, %f, %f, %f, %f\r\n', mmap.Writable, joy(1), joy(2), joy(3), joy(4), joy(5));
