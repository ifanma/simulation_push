function c3_derive_jacobian(param)
    ...
    fid=fopen(   'c3_linearization.m','w');
    fprintf(fid, 'function [A, B] = c3_linearization(t, param, dt, x)   \n\n');
    fprintf(fid, '[x_star, u_star] = param.traj(t, x, param);   \n\n');
